...
use pdao_metrics::registry::{Histogram, IntGauge};

const _METRIC_PREFIX: &str = "pdao_voter";
...
pub fn _block_indexing_time_ms() -> Histogram {
    static METER: Lazy<Histogram> = Lazy::new(|| {
        pdao_metrics::registry::register_histogram(
            _METRIC_PREFIX,
