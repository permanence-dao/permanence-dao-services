...
use polkadot::runtime_types::polkadot_runtime::RuntimeCall as PolkadotRuntimeCall;
...
impl Voter {
    ...
    fn get_polkadot_vote_call(
        ...
        balance: u128,
        conviction: u8,
    ) -> anyhow::Result<PolkadotRuntimeCall> {
        ...
        Ok(PolkadotRuntimeCall::Proxy(ProxyCall::proxy {
            real: real.into(),
